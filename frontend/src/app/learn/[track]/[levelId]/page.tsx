                ...
                .then(data => {
                    if (data.sections) {
                        ...
                        setGeneratedSections([
                            {
                                heading: 'Oops! Gagal Memuat Materi',
                                content: `Terjadi kendala saat menghubungi Dosen AI.\n\nPesan Error: ${data.error || 'Unknown Error'}\n\nPastikan API Key sudah benar dan koneksi internet stabil.`,
                                code: `Status: ${JSON.stringify(data)}`
                            }
                        ]);
                    }
                })
